...
function MovieItem() {
    const isMovieBanner = dataItems.filter((item) => item?.isBanner?.isMovie === true);
    const isMovieGenresList = videoGenresList.filter((item) => item.valueGenresType.includes('movie'));
